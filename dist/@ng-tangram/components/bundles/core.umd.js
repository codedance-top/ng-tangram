(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('@angular/cdk/platform'), require('@angular/cdk/coercion'), require('@angular/common'), require('@angular/cdk/overlay'), require('rxjs/add/observable/of'), require('rxjs/add/operator/do'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/filter'), require('@angular/animations'), require('@ng-tangram/animate/fading')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', '@angular/cdk/platform', '@angular/cdk/coercion', '@angular/common', '@angular/cdk/overlay', 'rxjs/add/observable/of', 'rxjs/add/operator/do', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/filter', '@angular/animations', '@ng-tangram/animate/fading'], factory) :
    (factory((global.nt = global.nt || {}, global.nt.components = global.nt.components || {}, global.nt.components.core = {}),global.ng.core,global.Rx.Subject,global.ng.cdk.platform,global.ng.cdk.coercion,global.ng.common,global.ng.cdk.overlay,null,null,null,null,global.ng.animations,global.nt.animate.fading));
}(this, (function (exports,core,Subject,platform,coercion,common,overlay,of,_do,debounceTime,filter,animations,fading) { 'use strict';
     ...
     */
    var /** @type {?} */ NT_DATE_LOCALE = new core.InjectionToken('nt-date-locale');
    /**
     * Provider for NT_DATE_LOCALE injection token.
     */
    var /** @type {?} */ NT_DATE_LOCALE_PROVIDER = { provide: NT_DATE_LOCALE, useExisting: core.LOCALE_ID };
    /**
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var /** @type {?} */ NT_DATE_FORMATS = new core.InjectionToken('nt-date-formats');
    ...
    ***************************************************************************** */
    ...
    var NativeDateAdapter = /** @class */ (function (_super) {
        ...
        function NativeDateAdapter(ntDateLocale, platform$$1) {
        ...
        NativeDateAdapter.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NT_DATE_LOCALE,] },] },
    ...
    var /** @type {?} */ NT_OPTION_PARENT_COMPONENT = new core.InjectionToken('nt-option-parent-component');
    var NtOptionComponent = /** @class */ (function () {
        ...
        NtOptionComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NT_OPTION_PARENT_COMPONENT,] },] },
        ]; };
    ...
    var NtOverlayComponent = /** @class */ (function () {
        function NtOverlayComponent(_renderer, _elementRef) {
            ...
            this._overlayClass = '';
            this._fixed = false;
            this._closeEvent = new core.EventEmitter();
            this._positionChange = new core.EventEmitter();
        ...
        Object.defineProperty(NtOverlayComponent.prototype, "fixed", {
             ...
             * @return {?}
             */
            function (value) { this._fixed = coercion.coerceBooleanProperty(value); this._setPosition(); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(NtOverlayComponent.prototype, "arrow", {
             ...
             * @return {?}
             */
            function (value) { this._arrow = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(NtOverlayComponent.prototype, "noSpacing", {
             ...
             * @return {?}
             */
            function (value) { this._noSpacing = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        NtOverlayComponent.propDecorators = {
            ...
            "noSpacing": [{ type: core.Input },],
            "trigger": [{ type: core.Input },],
            "overlayClass": [{ type: core.Input },],
    ...
    exports.NT_DATE_LOCALE = NT_DATE_LOCALE;
    exports.NT_DATE_LOCALE_PROVIDER = NT_DATE_LOCALE_PROVIDER;
    exports.DateAdapter = DateAdapter;
    exports.NT_DATE_FORMATS = NT_DATE_FORMATS;
    exports.NativeDateAdapter = NativeDateAdapter;
    exports.NT_NATIVE_DATE_FORMATS = NT_NATIVE_DATE_FORMATS;
    exports.NativeDateModule = NativeDateModule;
    exports.NtNativeDateModule = NtNativeDateModule;
    exports.NtOptionModule = NtOptionModule;
    exports.NtOptionSelectionChange = NtOptionSelectionChange;
    exports.NT_OPTION_PARENT_COMPONENT = NT_OPTION_PARENT_COMPONENT;
    exports.NtOptionComponent = NtOptionComponent;
    exports.NtOverlayModule = NtOverlayModule;
    exports.NtOverlayComponent = NtOverlayComponent;
    exports.NtOverlayOrientation = NtOverlayOrientation;
    exports.OVERLAY_POSITIONS = OVERLAY_POSITIONS;
    exports.getConnectionPositionPair = getConnectionPositionPair;
    exports.getPositionClassName = getPositionClassName;
    exports.getPositionOrientation = getPositionOrientation;
