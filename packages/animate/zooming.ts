    ...
    return animation(
      animate(
        ...
        keyframes([
          style({
            opacity: 0,
            transform: `scale3d(.1, .1, .1) ${translate3d(axis, 'a')}`,
            offset: 0,
          }),
          style({
            opacity: 1,
            transform: `scale3d(.475, .475, .475) ${translate3d(axis, 'b')}`,
            offset: 0.6,
          }),
        ])
      ),
    ...
    return animation(
      animate(
        ...
        keyframes([
          style({
            opacity: 1,
            transform: `scale3d(.475, .475, .475) ${translate3d(axis, 'a')}`,
            offset: 0.4,
          }),
          style({
            opacity: 0,
            transform: `scale3d(.1, .1, .1) ${translate3d(axis, 'b')}`,
            offset: 1,
          }),
        ])
      ),
