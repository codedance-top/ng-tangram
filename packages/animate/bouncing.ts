  ...
  return function (steps: any) {
    ...
    return animation(
      animate(
        '{{ timing }}s {{ delay }}s cubic-bezier(0.215, 0.610, 0.355, 1.000)',
        keyframes([
          style({ opacity: 0, transform: translate3d(axis, 'a'), offset: 0 }),
          style({ opacity: 1, transform: translate3d(axis, 'b'), offset: 0.6 }),
          style({ transform: translate3d(axis, 'c'), offset: 0.75 }),
          style({ transform: translate3d(axis, 'd'), offset: 0.9 }),
    ...
    return function (steps: any) {
      ...
      return animation(
        animate(
          '{{ timing }}s {{ delay }}s',
          keyframes([
            style({ transform: translate3d(axis, 'a'), offset: 0.2 }),
            style({ opacity: 1, transform: translate3d(axis, 'b'), offset: 0.4 }),
            style({ opacity: 1, transform: translate3d(axis, 'c'), offset: 0.45 }),
            style({ opacity: 0, transform: translate3d(axis, 'd'), offset: 1 }),
          ])
        ),
        { params }
      );
  ...
  return function (steps: any) {
    ...
    return animation(
      animate(
        '{{ timing }}s {{ delay }}s',
        keyframes([
          style({ opacity: 1, transform: translate3d(axis, 'a'), offset: 0.2 }),
          style({ opacity: 0, transform: translate3d(axis, 'b'), offset: 1 }),
        ])
      ),
      { params }
    );
