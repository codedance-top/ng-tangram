...
export const NT_OPTION_PARENT_COMPONENT = new InjectionToken<NtOptionParentComponent>('NT_OPTION_PARENT_COMPONENT');
...
export class NtOptionComponent implements AfterViewChecked {
  ...
  get label() { return this._element.nativeElement.textContent || ''; }
