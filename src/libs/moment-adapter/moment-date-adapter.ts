...
export interface NtMomentDateAdapterOptions {
  /**
...
export const NT_MOMENT_DATE_ADAPTER_OPTIONS = new InjectionToken<NtMomentDateAdapterOptions>(
  'nt-moment-date-adapter-options', {
    providedIn: 'root',
    factory: NT_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY
  });

/** @docs-private */
export function NT_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY(): NtMomentDateAdapterOptions {
  return {
    useUtc: false
  };
}
...
export class MomentDateAdapter extends DateAdapter<Moment> {
  ...
  constructor(
    @Optional() @Inject(NT_DATE_LOCALE) dateLocale: string,
    @Optional() @Inject(NT_MOMENT_DATE_ADAPTER_OPTIONS)
    private options?: NtMomentDateAdapterOptions) {
    super();
